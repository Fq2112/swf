...
@section('title', 'PPF Admins: Blog ['.$blog->title.'] Galleries Table | '.env('APP_TITLE'))
@push('styles')
...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Blog Galleries Table</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="{{route('admin.dashboard')}}">Dashboard</a></div>
                <div class="breadcrumb-item">Data Master</div>
                <div class="breadcrumb-item">Blog</div>
                <div class="breadcrumb-item"><a href="{{route('table.blog.posts', ['q' => $blog->title_uri])}}">Post</a></div>
                                ...
                                <table class="table table-striped" id="dt-buttons">
                                    ...
                                    @foreach($blog->getBlogGallery as $row)
                                        @php
                                            ...
                                            $url = route('detail.blog', ['author' => $blog->getUser->username,
